      ...
      <DataTable>
        ...
        <template v-slot:tb-btn-tab>
            <div class="btn-group mb-1" role="group">
              ...
              <button type="button" :class="{'btn':true ,'btn-primary': isActive != 3, 'active-nav': isActive == 3}" @click="filterStatus(3, 'hold by AP tagging')">Approved</button>
...
export default {
    ...
    created(){
      this.getAllTransaction()
       this.$store.dispatch('setHeaderTitle','Identify Transaction')
