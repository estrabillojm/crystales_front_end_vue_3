      ...
      <DataTable>
        ...
        <template v-slot:tb-btn-tab>
            <div class="btn-group mb-1" role="group">
              ...
              <button type="button" :class="{'btn':true ,'btn-primary': isActive != 3, 'active-nav': isActive == 3}" @click="filterStatus(3, 'hold by AP tagging')">Matched</button>
...
export default {
    ...
    created(){
      ...
      this.$store.dispatch('setHeaderTitle','Matching of Voucher')
    },
    computed:{
        ...mapState([
          'currentPage',
