      ...
      <DataTable>
        ...
        <template v-slot:tb-btn-tab>
            <div class="btn-group mb-1" role="group">
              ...
              <button type="button" :class="{'btn':true ,'btn-primary': isActive != 2, 'active-nav': isActive == 2}" @click="filterStatus(2, 'tagged by AP tagging')">Created</button>
...
export default {
    ...
    created(){
      ...
      this.$store.dispatch('setHeaderTitle','Creation of Cheque')
    },
    computed:{
      ...mapState([
        'currentPage',
